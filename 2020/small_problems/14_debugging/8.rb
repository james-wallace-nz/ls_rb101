...
# The password variable set on line 5 is not reassigned by the set_password method or passed into the verify_password method.
# Therefore, the password variable is not mutated by set_password or able to be checked by verify_password.
