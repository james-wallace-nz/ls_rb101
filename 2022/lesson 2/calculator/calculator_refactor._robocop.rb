...
loop do
  ...
  result = case operator
           when '1'   then (first.to_i + second.to_i).to_s
           when '2'   then (first.to_i - second.to_i).to_s
           when '3'   then (first.to_i * second.to_i).to_s
           when '4'   then (first.to_f / second.to_f).to_s
