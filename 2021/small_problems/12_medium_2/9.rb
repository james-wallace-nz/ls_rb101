...
# Define a method that performs bubble sort on an array
...
# Input: array
# output: same array in sorted order


# DATA STRUCTURES:

# Integer or String- compared
# Array
...
# - loop until
#   - set `swaps_made` to `false`
#   - loop through array (array size - 1) times
#     - for each iteration, compare current element to next element in array
#     - if first > second then
#       - swap elements in array (mutate)
#       - set `swaps_made` to `true`
#   - break from loop if `swaps_made` is equal to false
# - return array
...
def bubble_sort!(array)
  loop do
    ...
    (array.size - 1).times do |iteration|
